<!-- HERO SECTION -->
<section class="relative w-full h-[520px] bg-cover bg-center flex items-center" style="background-image: linear-gradient(to right, rgba(0, 0, 0, 0.7) 35%, rgba(0, 0, 0, 0.4) 100%), url('{{ asset('images/hero_banner.jpg') }}');">
